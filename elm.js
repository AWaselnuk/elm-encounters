...
var _user$elm_encounters$StatTables$deadlyThresholds = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 1, _1: 100},
...
var _user$elm_encounters$StatTables$hardThresholds = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 1, _1: 75},
...
var _user$elm_encounters$StatTables$mediumThresholds = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 1, _1: 50},
...
var _user$elm_encounters$StatTables$easyThresholds = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$elm_encounters$StatTables$ratingXpList = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$elm_encounters$StatTables$xpList = A2(_elm_lang$core$List$map, _elm_lang$core$Basics$snd, _user$elm_encounters$StatTables$ratingXpList);
var _user$elm_encounters$StatTables$ratingList = A2(_elm_lang$core$List$map, _elm_lang$core$Basics$fst, _user$elm_encounters$StatTables$ratingXpList);
var _user$elm_encounters$StatTables$ratingXPTable = _elm_lang$core$Dict$fromList(_user$elm_encounters$StatTables$ratingXpList);
var _user$elm_encounters$StatTables$xpRatingTable = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$map,
		function (row) {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$snd(row),
				_1: _elm_lang$core$Basics$fst(row)
			};
		},
...
var _user$elm_encounters$Utilities$getThreshold = F2(
	function (thresholds, level) {
		return A2(
			...
			0,
			A2(_elm_lang$core$Dict$get, level, thresholds));
	});
var _user$elm_encounters$Utilities$getDeadlyThreshold = _user$elm_encounters$Utilities$getThreshold(_user$elm_encounters$StatTables$deadlyThresholds);
var _user$elm_encounters$Utilities$getHardThreshold = _user$elm_encounters$Utilities$getThreshold(_user$elm_encounters$StatTables$hardThresholds);
var _user$elm_encounters$Utilities$getMediumThreshold = _user$elm_encounters$Utilities$getThreshold(_user$elm_encounters$StatTables$mediumThresholds);
var _user$elm_encounters$Utilities$getEasyThreshold = _user$elm_encounters$Utilities$getThreshold(_user$elm_encounters$StatTables$easyThresholds);
var _user$elm_encounters$Utilities$initRating = A2(
	_elm_lang$core$Maybe$withDefault,
	0,
...
var _user$elm_encounters$Utilities$safeRatingToXP = function (rating) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		A2(_elm_lang$core$Dict$get, rating, _user$elm_encounters$StatTables$ratingXPTable));
};
var _user$elm_encounters$Utilities$safeXPToRating = function (xp) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
...
var _user$elm_encounters$Character$new = F2(
	function (level, name) {
		return {
			level: level,
			name: _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$String$length(name),
				0) ? _user$elm_encounters$Character$randomName : name
		};
	});
var _user$elm_encounters$Character$init = A2(_user$elm_encounters$Character$new, 1, _user$elm_encounters$Character$randomName);
var _user$elm_encounters$Character$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _user$elm_encounters$Character$Model = F2(
	function (a, b) {
		return {level: a, name: b};
	});
var _user$elm_encounters$Character$ModifyName = function (a) {
	return {ctor: 'ModifyName', _0: a};
};
var _user$elm_encounters$Character$ModifyLevel = function (a) {
	return {ctor: 'ModifyLevel', _0: a};
};
var _user$elm_encounters$Character$levelOptionsView = function (model) {
	var levelOption = F2(
		function (level, isSelected) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$value(level),
...
var _user$elm_encounters$Character$view = function (model) {
	return A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(partyThresholds))
			]));
};
var _user$elm_encounters$CharacterList$calculatePartyThresholds = function (levels) {
	var deadlyPartyThresholds = A2(_elm_lang$core$List$map, _user$elm_encounters$Utilities$getDeadlyThreshold, levels);
	var hardPartyThresholds = A2(_elm_lang$core$List$map, _user$elm_encounters$Utilities$getHardThreshold, levels);
	var mediumPartyThresholds = A2(_elm_lang$core$List$map, _user$elm_encounters$Utilities$getMediumThreshold, levels);
	var easyPartyThresholds = A2(_elm_lang$core$List$map, _user$elm_encounters$Utilities$getEasyThreshold, levels);
	return {
		easy: _elm_lang$core$List$sum(easyPartyThresholds),
		medium: _elm_lang$core$List$sum(mediumPartyThresholds),
		hard: _elm_lang$core$List$sum(hardPartyThresholds),
		deadly: _elm_lang$core$List$sum(deadlyPartyThresholds)
	};
};
var _user$elm_encounters$CharacterList$levelsFromCharacterList = function (characterList) {
	return A2(
		_elm_lang$core$List$map,
		function (_p0) {
			return function (_) {
				...
				_elm_lang$core$Basics$snd(_p0));
		},
		characterList);
};
var _user$elm_encounters$CharacterList$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'NoOp':
			...
			case 'AddCharacter':
				var newCharacterList = A2(
					_elm_lang$core$List_ops['::'],
					{ctor: '_Tuple2', _0: model.uid, _1: _p1._0},
					model.characterList);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							partyThresholds: _user$elm_encounters$CharacterList$calculatePartyThresholds(
								_user$elm_encounters$CharacterList$levelsFromCharacterList(newCharacterList)),
							uid: model.uid + 1
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RemoveCharacter':
				var newCharacterList = A2(
					...
					function (_p2) {
						var _p3 = _p2;
						return !_elm_lang$core$Native_Utils.eq(_p3._0, _p1._0);
					},
					model.characterList);
				return {
					ctor: '_Tuple2',
			...
			case 'ModifyCharacter':
				var updateCharacter = function (_p4) {
					var _p5 = _p4;
					var _p7 = _p5._1;
					var _p6 = _p5._0;
					return _elm_lang$core$Native_Utils.eq(_p1._0, _p6) ? {
						ctor: '_Tuple2',
						_0: _p6,
						_1: _elm_lang$core$Basics$fst(
							A2(_user$elm_encounters$Character$update, _p1._1, _p7))
					} : {ctor: '_Tuple2', _0: _p6, _1: _p7};
				};
				var newCharacterList = A2(_elm_lang$core$List$map, updateCharacter, model.characterList);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'SetNewCharacterLevel':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newCharacterLevel: _p1._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newCharacterName: _p1._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$elm_encounters$CharacterList$initCharacterList = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 1, _1: _user$elm_encounters$Character$init},
		{ctor: '_Tuple2', _0: 2, _1: _user$elm_encounters$Character$init},
		{ctor: '_Tuple2', _0: 3, _1: _user$elm_encounters$Character$init},
		{ctor: '_Tuple2', _0: 4, _1: _user$elm_encounters$Character$init},
		{ctor: '_Tuple2', _0: 5, _1: _user$elm_encounters$Character$init}
	]);
var _user$elm_encounters$CharacterList$initPartyThresholds = _user$elm_encounters$CharacterList$calculatePartyThresholds(
	_user$elm_encounters$CharacterList$levelsFromCharacterList(_user$elm_encounters$CharacterList$initCharacterList));
var _user$elm_encounters$CharacterList$init = {uid: 6, characterList: _user$elm_encounters$CharacterList$initCharacterList, partyThresholds: _user$elm_encounters$CharacterList$initPartyThresholds, newCharacterLevel: 1, newCharacterName: ''};
var _user$elm_encounters$CharacterList$PartyThresholds = F4(
	function (a, b, c, d) {
		return {easy: a, medium: b, hard: c, deadly: d};
	});
var _user$elm_encounters$CharacterList$Model = F5(
	function (a, b, c, d, e) {
		return {uid: a, characterList: b, partyThresholds: c, newCharacterLevel: d, newCharacterName: e};
	});
var _user$elm_encounters$CharacterList$SetNewCharacterName = function (a) {
	return {ctor: 'SetNewCharacterName', _0: a};
};
var _user$elm_encounters$CharacterList$SetNewCharacterLevel = function (a) {
	return {ctor: 'SetNewCharacterLevel', _0: a};
};
var _user$elm_encounters$CharacterList$levelOptionsView = function (model) {
	var levelOption = F2(
		function (level, isSelected) {
			return A2(
				_elm_lang$html$Html$option,
...
var _user$elm_encounters$CharacterList$ModifyCharacter = F2(
	function (a, b) {
		return {ctor: 'ModifyCharacter', _0: a, _1: b};
	});
var _user$elm_encounters$CharacterList$RemoveCharacter = function (a) {
	return {ctor: 'RemoveCharacter', _0: a};
};
var _user$elm_encounters$CharacterList$indexedCharacterView = function (_p8) {
	var _p9 = _p8;
	var _p10 = _p9._0;
	return A2(
		_elm_lang$html$Html$div,
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$elm_encounters$CharacterList$ModifyCharacter(_p10),
				_user$elm_encounters$Character$view(_p9._1)),
				A2(
...
var _user$elm_encounters$CharacterList$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		A2(_elm_lang$core$List$map, _user$elm_encounters$CharacterList$indexedCharacterView, model.characterList));
};
var _user$elm_encounters$CharacterList$AddCharacter = function (a) {
	return {ctor: 'AddCharacter', _0: a};
};
var _user$elm_encounters$CharacterList$addCharacterView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$elm_encounters$CharacterList$NoOp = {ctor: 'NoOp'};

var _user$elm_encounters$Monster$randomName = 'Monster Name';
var _user$elm_encounters$Monster$new = F2(
	function (rating, name) {
		return {
			xp: _user$elm_encounters$Utilities$safeRatingToXP(rating),
			name: _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$String$length(name),
				0) ? _user$elm_encounters$Monster$randomName : name,
			rating: rating
		};
	});
var _user$elm_encounters$Monster$init = A2(_user$elm_encounters$Monster$new, 1, _user$elm_encounters$Monster$randomName);
var _user$elm_encounters$Monster$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ModifyRating':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							rating: _p1,
							xp: _user$elm_encounters$Utilities$safeRatingToXP(_p1)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ModifyXP':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							rating: _user$elm_encounters$Utilities$safeXPToRating(_p2),
							xp: _p2
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$elm_encounters$Monster$Model = F3(
	function (a, b, c) {
		return {xp: a, rating: b, name: c};
	});
var _user$elm_encounters$Monster$ModifyName = function (a) {
	return {ctor: 'ModifyName', _0: a};
};
var _user$elm_encounters$Monster$ModifyRating = function (a) {
	return {ctor: 'ModifyRating', _0: a};
};
var _user$elm_encounters$Monster$monsterRatingOptionsView = function (model) {
	var monsterRatingOption = F2(
		function (rating, isSelected) {
			return A2(
				_elm_lang$html$Html$option,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$value(rating),
						_elm_lang$html$Html_Attributes$selected(isSelected)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(rating)
					]));
		});
	var monsterRatingOptions = A2(
		_elm_lang$core$List$map,
		function (rating) {
			return A2(
				monsterRatingOption,
...
var _user$elm_encounters$Monster$ModifyXP = function (a) {
	return {ctor: 'ModifyXP', _0: a};
};
var _user$elm_encounters$Monster$monsterXpOptionsView = function (model) {
	var monsterXpOption = F2(
		function (xp, isSelected) {
			return A2(
				_elm_lang$html$Html$option,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$value(xp),
						_elm_lang$html$Html_Attributes$selected(isSelected)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(xp)
					]));
		});
	var monsterXpOptions = A2(
		_elm_lang$core$List$map,
		function (xp) {
			return A2(
				monsterXpOption,
				_elm_lang$core$Basics$toString(xp),
...
var _user$elm_encounters$Monster$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('inline-form-control monster-rating-wrapper')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$elm_encounters$Monster$monsterRatingOptionsView(model)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('inline-form-control monster-xp-wrapper')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$elm_encounters$Monster$monsterXpOptionsView(model)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('inline-form-control monster-name-wrapper')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('monster-name'),
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$value(model.name),
								_elm_lang$html$Html_Events$onInput(_user$elm_encounters$Monster$ModifyName)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]))
...
var _user$elm_encounters$MonsterList$calculateMonsterMultiplier = function (taggedMonsters) {
	var monsterCount = _elm_lang$core$List$length(taggedMonsters);
	return (_elm_lang$core$Native_Utils.eq(monsterCount, 0) || _elm_lang$core$Native_Utils.eq(monsterCount, 1)) ? 1 : (((_elm_lang$core$Native_Utils.cmp(monsterCount, 2) > -1) || (_elm_lang$core$Native_Utils.cmp(monsterCount, 3) < 0)) ? 1.5 : (((_elm_lang$core$Native_Utils.cmp(monsterCount, 3) > -1) || (_elm_lang$core$Native_Utils.cmp(monsterCount, 7) < 0)) ? 2 : (((_elm_lang$core$Native_Utils.cmp(monsterCount, 7) > -1) || (_elm_lang$core$Native_Utils.cmp(monsterCount, 11) < 0)) ? 2.5 : (((_elm_lang$core$Native_Utils.cmp(monsterCount, 11) > -1) || (_elm_lang$core$Native_Utils.cmp(monsterCount, 15) < 0)) ? 3 : 4))));
};
var _user$elm_encounters$MonsterList$calculateMonsterXPTotal = function (taggedMonsters) {
	var multiplier = _user$elm_encounters$MonsterList$calculateMonsterMultiplier(taggedMonsters);
	var monsters = A2(_elm_lang$core$List$map, _elm_lang$core$Basics$snd, taggedMonsters);
	var totalMonsterXPs = _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
			function (_) {
				return _.xp;
		...
		switch (_p0.ctor) {
			case 'AddMonster':
				var newMonsterList = A2(
					_elm_lang$core$List_ops['::'],
					{ctor: '_Tuple2', _0: model.uid, _1: _p0._0},
					model.monsterList);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							monsterXpTotal: _user$elm_encounters$MonsterList$calculateMonsterXPTotal(newMonsterList),
							uid: model.uid + 1
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'ModifyMonster':
				var updateMonster = function (_p3) {
					var _p4 = _p3;
					var _p6 = _p4._1;
					var _p5 = _p4._0;
					return _elm_lang$core$Native_Utils.eq(_p0._0, _p5) ? {
						...
						_0: _p5,
						_1: _elm_lang$core$Basics$fst(
							A2(_user$elm_encounters$Monster$update, _p0._1, _p6))
					} : {ctor: '_Tuple2', _0: _p5, _1: _p6};
				};
				var newMonsterList = A2(_elm_lang$core$List$map, updateMonster, model.monsterList);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'SetNewMonsterName':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newMonsterName: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetNewMonsterRating':
				var _p7 = _p0._0;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							newMonsterRating: _user$elm_encounters$Utilities$safeXPToRating(_p8),
							newMonsterXP: _p8
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$elm_encounters$MonsterList$init = {
	uid: 1,
	monsterList: _elm_lang$core$Native_List.fromArray(
		[]),
	monsterXpTotal: 0,
	newMonsterName: '',
	newMonsterRating: _user$elm_encounters$Utilities$initRating,
	newMonsterXP: _user$elm_encounters$Utilities$safeRatingToXP(_user$elm_encounters$Utilities$initRating)
};
var _user$elm_encounters$MonsterList$Model = F6(
	function (a, b, c, d, e, f) {
		return {uid: a, monsterList: b, monsterXpTotal: c, newMonsterName: d, newMonsterRating: e, newMonsterXP: f};
	});
var _user$elm_encounters$MonsterList$SetNewMonsterRating = function (a) {
	return {ctor: 'SetNewMonsterRating', _0: a};
};
var _user$elm_encounters$MonsterList$monsterRatingOptionsView = function (model) {
	var monsterRatingOption = F2(
		function (rating, isSelected) {
			return A2(
				_elm_lang$html$Html$option,
...
var _user$elm_encounters$MonsterList$SetNewMonsterXP = function (a) {
	return {ctor: 'SetNewMonsterXP', _0: a};
};
var _user$elm_encounters$MonsterList$monsterXpOptionsView = function (model) {
	var monsterXpOption = F2(
		function (xp, isSelected) {
			return A2(
				_elm_lang$html$Html$option,
...
var _user$elm_encounters$MonsterList$SetNewMonsterName = function (a) {
	return {ctor: 'SetNewMonsterName', _0: a};
};
var _user$elm_encounters$MonsterList$ModifyMonster = F2(
	function (a, b) {
		return {ctor: 'ModifyMonster', _0: a, _1: b};
	});
var _user$elm_encounters$MonsterList$RemoveMonster = function (a) {
	return {ctor: 'RemoveMonster', _0: a};
};
var _user$elm_encounters$MonsterList$indexedMonsterView = function (_p9) {
	var _p10 = _p9;
	var _p11 = _p10._0;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('inline-form monster')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html_App$map,
				_user$elm_encounters$MonsterList$ModifyMonster(_p11),
				_user$elm_encounters$Monster$view(_p10._1)),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('inline-form-control btn btn-remove-monster'),
						_elm_lang$html$Html_Events$onClick(
						_user$elm_encounters$MonsterList$RemoveMonster(_p11))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('X')
...
var _user$elm_encounters$MonsterList$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('monsters')
			]),
		A2(_elm_lang$core$List$map, _user$elm_encounters$MonsterList$indexedMonsterView, model.monsterList));
};
var _user$elm_encounters$MonsterList$AddMonster = function (a) {
	return {ctor: 'AddMonster', _0: a};
};
var _user$elm_encounters$MonsterList$addMonsterView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('form-control-left-right')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('form-control form-control-left')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('form-control form-control-right')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
...
var _user$elm_encounters$Encounter$debugView = function (model) {
	return A2(
		_elm_lang$html$Html$p,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$elm_encounters$Encounter$calculateDifficulty = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Basics$round(model.monsters.monsterXpTotal),
		model.characters.partyThresholds.easy) < 0) ? 'easy' : ((_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Basics$round(model.monsters.monsterXpTotal),
		model.characters.partyThresholds.medium) < 0) ? 'medium' : ((_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Basics$round(model.monsters.monsterXpTotal),
...
var _user$elm_encounters$Encounter$titleSectionView = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('title-section')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
...
var _user$elm_encounters$Encounter$difficultyBadgeView = function (model) {
	var badgeClass = A2(
		_elm_lang$core$Basics_ops['++'],
		'badge badge--',
		_user$elm_encounters$Encounter$calculateDifficulty(model));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class(badgeClass)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('difficulty')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
...
var _user$elm_encounters$Encounter$monsterSectionView = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('monster-section')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$elm_encounters$MonsterList$summaryView(model)),
				A2(
				_elm_lang$html$Html$h3,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Add new monster')
					])),
				A2(
				_elm_lang$html$Html_App$map,
				_user$elm_encounters$Encounter$MonsterListMsg,
				_user$elm_encounters$MonsterList$addMonsterView(model)),
				A2(
				_elm_lang$html$Html$h3,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Current monsters')
					])),
				A2(
				_elm_lang$html$Html_App$map,
				_user$elm_encounters$Encounter$MonsterListMsg,
				_user$elm_encounters$MonsterList$view(model))
			]));
};
var _user$elm_encounters$Encounter$CharacterListMsg = function (a) {
	return {ctor: 'CharacterListMsg', _0: a};
};
var _user$elm_encounters$Encounter$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
			...
			case 'CharacterListMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{characters: clModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$elm_encounters$Encounter$CharacterListMsg, clCmd)
				};
			default:
				var _p2 = A2(_user$elm_encounters$MonsterList$update, _p0._0, model.monsters);
				var mlModel = _p2._0;
				var mlCmd = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{monsters: mlModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$elm_encounters$Encounter$MonsterListMsg, mlCmd)
				};
		}
	});
var _user$elm_encounters$Encounter$encounterSummaryView = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('encounter-summary-section')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$elm_encounters$Encounter$partySectionView = function (model) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('party-section')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Add new character')
					])),
				A2(
				_elm_lang$html$Html_App$map,
				_user$elm_encounters$Encounter$CharacterListMsg,
...
var _user$elm_encounters$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			view: _user$elm_encounters$Encounter$view,
			update: _user$elm_encounters$Encounter$update,
			init: _user$elm_encounters$Encounter$init,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _user$elm_encounters$Main$main === 'undefined' ? null : _user$elm_encounters$Main$main);
